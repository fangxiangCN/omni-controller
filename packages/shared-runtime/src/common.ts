...
import { ifInNode } from '@omni/shared-types/utils';
...
export const getRunBaseDir = () => {
  if (!ifInNode) {
    return '';
  }

  let basePath = path.resolve(process.cwd(), getRunDir());
