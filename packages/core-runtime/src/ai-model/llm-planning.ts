...
import type { IModelConfig, TModelFamily } from '@omni/shared-runtime/env';
import { paddingToMatchBlockByBase64 } from '@omni/shared-runtime/img';
...
export async function plan(
  ...
  actions.forEach((action) => {
    ...
    const locateFields = actionInActionSpace
      ? findAllLocatorField(actionInActionSpace.paramSchema)
      : [];
