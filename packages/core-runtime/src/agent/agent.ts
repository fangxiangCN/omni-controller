...
import type { YamlScript } from '../yaml';
...
import { imageInfoOfBase64, resizeImgBase64 } from '@omni/shared-runtime/img';
import { getDebug } from '@omni/shared-runtime/logger';
import { assert, ifInBrowser, uuid } from '@omni/shared-types/utils';
...
> {
  ...
  wrapActionInActionSpace<T extends DeviceAction>(
    ...
    return async (param: ActionParam<T>) => {
      return (await this.callActionInActionSpace(name, param)) as ActionReturn<T>;
    };
  }
