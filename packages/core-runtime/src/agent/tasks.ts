...
import { type IModelConfig, getCurrentTime } from '@omni/shared-runtime/env';
...
import { descriptionOfTree } from '@omni/shared-types/extractor';
...
export class TaskExecutor {
  ...
  async action(
    ...
    ExecutionResult<
      | {
          yamlFlow?: YamlFlowItem[]; // for cache use
          output?: string;
        }
      | undefined
    >
