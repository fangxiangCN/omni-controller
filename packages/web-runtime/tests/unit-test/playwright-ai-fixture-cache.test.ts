...
// IMPORTANT: This must be before any imports that might use @omni/shared-runtime/env
vi.mock('@omni/shared-runtime/env', () => ({
...
import { processCacheConfig } from '@omni/core-runtime/utils';
