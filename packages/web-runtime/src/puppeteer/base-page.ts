...
import type {
  ...
  Size,
  UIContext,
} from '@omni/core-runtime';
import {
  AiJudgeOrderSensitive,
  callAIWithObjectResponse,
} from '@omni/core-runtime/ai-model';
import type { AbstractInterface } from '@omni/core-runtime/device';
import { sleep } from '@omni/core-runtime/utils';
import {
  DEFAULT_WAIT_FOR_NAVIGATION_TIMEOUT,
  DEFAULT_WAIT_FOR_NETWORK_IDLE_CONCURRENCY,
  DEFAULT_WAIT_FOR_NETWORK_IDLE_TIMEOUT,
} from '@omni/shared-types/constants';
import type { IModelConfig } from '@omni/shared-runtime/env';
import type { ElementInfo } from '@omni/shared-types/extractor';
import { treeToList } from '@omni/shared-types/extractor';
import { createImgBase64ByFormat } from '@omni/shared-runtime/img';
import { type DebugFunction, getDebug } from '@omni/shared-runtime/logger';
import {
  getElementInfosScriptContent,
  getExtraReturnLogic,
} from '@omni/shared-runtime/node';
import { assert } from '@omni/shared-types/utils';
...
> implements AbstractInterface
{
  ...
  async registerFileChooserListener(
    handler: (
      chooser: import('@omni/core-runtime/device').FileChooserHandler,
    ) => Promise<void>,
