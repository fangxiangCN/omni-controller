...
} from '@omni/core/ai-model';
import type { AbstractInterface } from '@omni/core/device';
import { sleep } from '@omni/core/utils';
import {
  DEFAULT_WAIT_FOR_NAVIGATION_TIMEOUT,
  DEFAULT_WAIT_FOR_NETWORK_IDLE_CONCURRENCY,
  DEFAULT_WAIT_FOR_NETWORK_IDLE_TIMEOUT,
} from '@omni/shared/constants';
import type { IModelConfig } from '@omni/shared/env';
import type { ElementInfo } from '@omni/shared/extractor';
import { treeToList } from '@omni/shared/extractor';
import { createImgBase64ByFormat } from '@omni/shared/img';
import { type DebugFunction, getDebug } from '@omni/shared/logger';
import {
  getElementInfosScriptContent,
  getExtraReturnLogic,
} from '@omni/shared/node';
...
> implements AbstractInterface
{
  ...
  async registerFileChooserListener(
    handler: (
      chooser: import('@omni/core/device').FileChooserHandler,
    ) => Promise<void>,
