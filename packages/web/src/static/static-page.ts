import type { DeviceAction, Point, UIContext } from '@omni/core';
import type { AbstractInterface } from '@omni/core/device';
import { ScreenshotItem } from '@omni/core';
import {
...
import { ERROR_CODE_NOT_IMPLEMENTED_AS_DESIGNED } from '@omni/shared/common';
