...
import type { Agent, Agent as PageAgent } from '@omni/core-runtime/agent';
 ...
 * @example
 * ```typescript
 * import { playgroundForAgent } from '@omni/playground';
 * import { SampleDevice, Agent } from '@omni/core-runtime';
 *
