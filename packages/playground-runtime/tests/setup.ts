...
vi.mock('@omni/shared-types/us-keyboard-layout', () => ({
  isMac: false,
  keyMap: {},
  modifierKeys: [],
  _keyCode: 0,
...
vi.mock('@omni/shared-runtime/img/get-photon', () => ({
  default: vi.fn(),
}));
...
vi.mock('@omni/core-runtime/ai-model', () => ({
...
vi.mock('@omni/core-runtime/agent', () => ({
