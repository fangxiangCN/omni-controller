...
// Omni aliases (env keys unchanged)
export const OMNI_DEBUG_MODE = MIDSCENE_DEBUG_MODE;
export const OMNI_FORCE_DEEP_THINK = MIDSCENE_FORCE_DEEP_THINK;
...
export const OMNI_LANGSMITH_DEBUG = MIDSCENE_LANGSMITH_DEBUG;
export const OMNI_LANGFUSE_DEBUG = MIDSCENE_LANGFUSE_DEBUG;
...
export const OMNI_MODEL_MAX_TOKENS = MIDSCENE_MODEL_MAX_TOKENS;
...
export const OMNI_CACHE = MIDSCENE_CACHE;
...
export const OMNI_REPORT_TAG_NAME = MIDSCENE_REPORT_TAG_NAME;
export const OMNI_REPORT_QUIET = MIDSCENE_REPORT_QUIET;
...
export const OMNI_CACHE_MAX_FILENAME_LENGTH = MIDSCENE_CACHE_MAX_FILENAME_LENGTH;

export const MIDSCENE_REPLANNING_CYCLE_LIMIT =
  'MIDSCENE_REPLANNING_CYCLE_LIMIT';
// Alias for omni naming, keep env key unchanged
export const OMNI_REPLANNING_CYCLE_LIMIT = MIDSCENE_REPLANNING_CYCLE_LIMIT;

export const MIDSCENE_RUN_DIR = 'MIDSCENE_RUN_DIR';
export const OMNI_RUN_DIR = MIDSCENE_RUN_DIR;
 ...
 * - planning: planning
 * - default: all except insight銆乸lanning
 */
