...
// Reference the following code to generate Omni test cases
// The following is test code for Omni AI, for reference
...
import type { PlayWrightAiFixtureType } from '@omni/web/playwright';
import { PlaywrightAiFixture } from '@omni/web/playwright';
  ...
  - name: <name>
    ...
    flow:
      ...
      - aiTap: <prompt>
        ...
        xpath: <xpath> # Optional, the xpath of the target element for the operation. If provided, Omni will prioritize this xpath to find the element before using the cache and the AI model. Defaults to empty.
        cacheable: <boolean> # Optional, whether to cache the result of this API call when the [caching feature](./caching.mdx) is enabled. Defaults to True.
